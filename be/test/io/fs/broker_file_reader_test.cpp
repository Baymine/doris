...
public:
    ...
    MOCK_METHOD(void, listLocatedFiles, (TBrokerListResponse&, const TBrokerListPathRequest&),
                (override));
    MOCK_METHOD(void, isSplittable,
                (TBrokerIsSplittableResponse&, const TBrokerIsSplittableRequest&), (override));
    MOCK_METHOD(void, deletePath, (TBrokerOperationStatus&, const TBrokerDeletePathRequest&),
                (override));
    MOCK_METHOD(void, renamePath, (TBrokerOperationStatus&, const TBrokerRenamePathRequest&),
                (override));
    MOCK_METHOD(void, checkPathExist,
                (TBrokerCheckPathExistResponse&, const TBrokerCheckPathExistRequest&), (override));
    MOCK_METHOD(void, openReader, (TBrokerOpenReaderResponse&, const TBrokerOpenReaderRequest&),
                (override));
    ...
    MOCK_METHOD(void, closeReader, (TBrokerOperationStatus&, const TBrokerCloseReaderRequest&),
                (override));
    MOCK_METHOD(void, openWriter, (TBrokerOpenWriterResponse&, const TBrokerOpenWriterRequest&),
                (override));
    MOCK_METHOD(void, pwrite, (TBrokerOperationStatus&, const TBrokerPWriteRequest&), (override));
    MOCK_METHOD(void, closeWriter, (TBrokerOperationStatus&, const TBrokerCloseWriterRequest&),
                (override));
    MOCK_METHOD(void, ping, (TBrokerOperationStatus&, const TBrokerPingBrokerRequest&), (override));
    MOCK_METHOD(void, fileSize, (TBrokerFileSizeResponse&, const TBrokerFileSizeRequest&),
                (override));
};
...
TEST_F(BrokerFileReaderTest, SingleReadModeWithNonPositive) {
    ...
    auto reader =
            std::make_unique<BrokerFileReader>(_broker_addr, _path, _file_size, _fd, connection);
...
TEST_F(BrokerFileReaderTest, EOFHandling) {
    ...
    EXPECT_CALL(*_mock_client, pread(testing::_, testing::_))
            .WillOnce([this](TBrokerReadResponse& response, const TBrokerPReadRequest& request) {
...
TEST_F(BrokerFileReaderTest, BrokerError) {
    ...
    EXPECT_CALL(*_mock_client, pread(testing::_, testing::_))
            .WillOnce([](TBrokerReadResponse& response, const TBrokerPReadRequest& request) {
                TBrokerOperationStatus op_status;
...
TEST_F(BrokerFileReaderTest, ReadAtDifferentOffsets) {
    ...
    EXPECT_CALL(*_mock_client, pread(testing::_, testing::_))
            .WillRepeatedly([this, &requests](TBrokerReadResponse& response,
                                              const TBrokerPReadRequest& request) {
                requests.emplace_back(request.offset, request.length);
                setup_read_response(response, TBrokerOperationStatusCode::OK,
